 ...
 */
public class GenericBlockWriter extends BlockWriter<ByteString> {
  ...
  protected GenericBlockWriter(OutputStream out, Class<M> protoClass, BinaryConverter<M> binaryConverter, int numRecordsPerBlock) {
    out_ = out;
